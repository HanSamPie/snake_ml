...
# CHANGES
# TODO instead of one-hot encoding this version should learn the embedding itself
# this would greatly reduce the amount if inputs
# or alternatively just us ints for the different values
# Action mapping
ACTION_MAP = {
    0: (-1, 0),   # up
    1: (0, 1),    # right
